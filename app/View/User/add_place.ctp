 ...
 *********************************************************/
 ?>
<?php echo $this->Html->script('add_place'); ?>
<?php echo $this->Html->css('add_place'); ?>
...
<div id="add_place" class="container">
	<form id="add_place_form">
		<div class="col-xs-12 col-sm-8 hide_on_xs">
			...
			<div class="col-xs-12 contacts">
					...
					<div class="col-xs-12 col-sm-4">
						<input type="email" id="email" name="phone" placeholder="E-mail address" />
					</div>
				</div>
			<hr class="visible-xs" />
		</div>
		<div class="col-xs-12 col-sm-4" style="height: 100%;">
			...
			<div id="place_tags" style="display: none;">
